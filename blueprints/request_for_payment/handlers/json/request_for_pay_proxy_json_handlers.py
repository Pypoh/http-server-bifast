...
def buildMessage(data):
    ...
    proxy_data = {
        "Id": generalData.sampleData.get('DBTRACCT_PRXY_ID'),
        "Tp": {
            "Prtry": generalData.sampleData.get('DBTRACCT_PRXY_TYPE')
        }
    }
    filled_data['BusMsg']['Document']['CdtrPmtActvtnReq']['PmtInf'][0]['DbtrAcct']['Prxy'] = proxy_data
