...
def requestMessageByCreditor(requestData):
    ...
    filled_data["BusMsg"]["Document"]["MndtInitnReq"]["Mndt"][0]["FrstColltnAmt"]["value"] = float(requestData.get('FrstColltnAmt_value'))
    filled_data["BusMsg"]["Document"]["MndtInitnReq"]["Mndt"][0]["ColltnAmt"]["value"] = float(requestData.get('ColltnAmt_value'))
    filled_data["BusMsg"]["Document"]["MndtInitnReq"]["Mndt"][0]["MaxAmt"]["value"] = float(requestData.get('MaxAmt_value'))
    filled_data["BusMsg"]["Document"]["MndtInitnReq"]["Mndt"][0]["Ocrncs"]["Frqcy"]["Prd"]["CntPerPrd"] = float(requestData.get('Frqcy_cntPerPrd'))
    headers = {
