...
def requestMessage():
    ...
    with open(filePath, 'r') as file:
        ...
        value_dict = {
            ...
            "END_TO_END_ID_VALUE": handler.generateBizMsgIdr("853"),
            ...
            "SPLMNTR_CDTR_TP_VALUE": 1,
            "SPLMNTR_CDTR_RSDNTSTS_VALUE": 1,
            "SPLMNTR_CDTR_TWNNM_VALUE": 300,
        }
    ...
    response = requests.post(
        f"{SCHEME_VALUE}{HOST_URL_VALUE}:{HOST_PORT_VALUE}", json=filled_data)
