...
function checkInputData(payment_id) {
  var nboftxs = getInputValue(`#count_${payment_id}`);
...
async function requestBulk(payment_url, payment_id, inquiry_url) {
  ...
  try {
    ...
    clearConsole();
    var data = Object.assign({}, participantData, inputData);
